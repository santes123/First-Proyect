...
public class GameActivitySelector6 extends AppCompatActivity {
        ...
        btnSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(getType(id)=="radio"){
                    ...
                    Log.d("listResultados6 = ", String.valueOf((listaResultados.size())));
        ...
        APIClientGravity.getInstance().getApi().getFormApi(Integer.valueOf(id)).enqueue(
                new Callback<Form>() {
                    ...
                    public void onResponse(Call<Form> call,
                        ...
                        if (!GameActivitySelector6.this.isFinishing() && progressDialog.isShowing())
                        ...
                        if (response.isSuccessful()) {
                            ...
                            for(Form.Choice opcion : list) {
                                ...
                                if(opcion.getText().equals(selectedText)){
                                    ...
                                    Log.d("listResultadosEntrada6 = ", objeto);
                                    Log.d("listaResultadosSizeFor6 = ", String.valueOf(ListaResultadosConvertida.size()));
                                }else{
                                    Log.d("listResultadosEntrada6 = ", "NO HAY OBJETOS QUE COINCIDAN");
                                }
                            }

                            Log.d("listaResultadosSizeOutFor6 = ", String.valueOf(ListaResultadosConvertida.size()));
                            ...
                            for (int i = 0; i < ListaResultadosConvertida.size(); i++){
                                ...
                                Log.d("listResultadosSalida6 = ", opcion);
