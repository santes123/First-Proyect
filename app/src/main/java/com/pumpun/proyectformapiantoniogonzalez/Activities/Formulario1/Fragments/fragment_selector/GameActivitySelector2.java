...
public class GameActivitySelector2 extends AppCompatActivity {
              ...
              //  listaResultados= new ArrayList<String>();
               // getEntryData(id);
                ...
                if(getType(id)=="radio"){
                    ...
                    Log.d("listResultados2 = ", String.valueOf((listaResultados.size())));
        ...
        APIClientGravity.getInstance().getApi().getFormApi(Integer.valueOf(id)).enqueue(
                new Callback<Form>() {
                    ...
                    public void onResponse(Call<Form> call,
                        ...
                        if (!GameActivitySelector2.this.isFinishing() && progressDialog.isShowing())
                ...
                new Callback<Form>() {
                    ...
                    public void onResponse(Call<Form> call,
                        ...
                        if (response.isSuccessful()) {
                            ...
                            //RECOJEMOS LA LISTA DE LA ACTIVITY 1
                            ...
                            for(Form.Choice opcion : list) {
                                ...
                                if(opcion.getText().equals(selectedText)){
                                    ...
                                    Log.d("listResultadosEntrada = ", objeto);
                                    Log.d("listaResultadosSizeFor = ", String.valueOf(ListaResultadosConvertida.size()));
                                }else{
                                    Log.d("listResultadosEntrada = ", "NO HAY OBJETOS QUE COINCIDAN");
                                }
                            }

                            Log.d("listaResultadosSizeOutFor = ", String.valueOf(ListaResultadosConvertida.size()));
                            ...
                            for (int i = 0; i < ListaResultadosConvertida.size(); i++){
                                ...
                                Log.d("listResultadosSalida2 = ", opcion);
