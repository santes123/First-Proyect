...
public class GameActivitySelector3 extends AppCompatActivity {
...
// Later.. stop the animation
    ...
    public void btnSiguiente() {
        ...
        btnSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d("progress : ", String.valueOf(Integer.valueOf(newProgress)));
                ...
                if(getType(id)=="radio"){
                    ...
                    //intent.putExtra("parametro3", String.valueOf(listaResultados));
                    ...
                    Intent intent = new Intent(v.getContext(), GameActivitySelector4.class);
                    intent.putExtra("parametro", contador);
                    intent.putExtra("parametro2", progress);
                   // intent.putExtra("parametro3", String.valueOf(listaResultados));
                    intent.putStringArrayListExtra("parametro3", (ArrayList<String>) listaResultados);
                    Log.d("listResultados3 = ", String.valueOf((listaResultados.size())));
        ...
        APIClientGravity.getInstance().getApi().getFormApi(Integer.valueOf(id)).enqueue(
                new Callback<Form>() {
                    ...
                    public void onResponse(Call<Form> call,
                        ...
                        if (!GameActivitySelector3.this.isFinishing() && progressDialog.isShowing())
    ...
    //CONTINUAR CON EL METODO GETENTRYDATA(CORREGIR EL METODO EN TODAS LAS CLASES(COMO EL DE LA CLASE 2,AÑADIR EN EXTRAS LA LISTA,INVOCAR EL METODO JUSTO ANTES
    //Y CUANDO ESTEN TODOS LOS DATOS RECOGIDOS,PASARLOS EN LA CLASE GAMEACTIVITYTEXT2 AL METODO POSTDATA(COMO UN OBJETO ENTRYFORM

    //PROBLEMAS EN GAMEACTIVITYSELECTOR2(AL FINAL AL INTENTAR AÑADIR LA LISTA
                        ...
                        if (response.isSuccessful()) {
                            ...
                            for(Form.Choice opcion : list) {
                                ...
                                if(opcion.getText().equals(selectedText)){
                                    ...
                                    Log.d("listResultadosEntrada3 = ", objeto);
                                    Log.d("listaResultadosSizeFor3 = ", String.valueOf(ListaResultadosConvertida.size()));
                                }else{
                                    Log.d("listResultadosEntrada3 = ", "NO HAY OBJETOS QUE COINCIDAN");
                                }
                            }

                            Log.d("listaResultadosSizeOutFor3 = ", String.valueOf(ListaResultadosConvertida.size()));
                            ...
                            for (int i = 0; i < ListaResultadosConvertida.size(); i++){
                                ...
                                Log.d("listResultadosSalida3 = ", opcion);
