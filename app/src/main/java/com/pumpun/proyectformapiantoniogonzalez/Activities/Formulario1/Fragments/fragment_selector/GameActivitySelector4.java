...
public class GameActivitySelector4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* int maxValue=simpleProgressBar.getMax(); // get maximum value of the progress bar
        ...
        simpleProgressBar.setProgress(30);
        ...
        btnSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(getType(id)=="radio"){
                    ...
                    Log.d("listResultados4 = ", String.valueOf((listaResultados.size())));
                    ...
                    Intent intent = new Intent(v.getContext(), GameActivitySelector5.class);
                    intent.putExtra("parametro", contador);
                    intent.putExtra("parametro2", progress);
                    intent.putStringArrayListExtra("parametro3", (ArrayList<String>) listaResultados);
                    Log.d("listResultados4 = ", String.valueOf((listaResultados.size())));
        ...
        APIClientGravity.getInstance().getApi().getFormApi(Integer.valueOf(id)).enqueue(
                new Callback<Form>() {
                    ...
                    public void onResponse(Call<Form> call,
                        ...
                        if (!GameActivitySelector4.this.isFinishing() && progressDialog.isShowing())
                        ...
                        if (response.isSuccessful()) {
                            ...
                            for(Form.Choice opcion : list) {
                                ...
                                if(opcion.getText().equals(selectedText)){
                                    ...
                                    Log.d("listResultadosEntrada4 = ", objeto);
                                    Log.d("listaResultadosSizeFor4 = ", String.valueOf(ListaResultadosConvertida.size()));
                                }else{
                                    Log.d("listResultadosEntrada4 = ", "NO HAY OBJETOS QUE COINCIDAN");
                                }
                            }

                            Log.d("listaResultadosSizeOutFor4 = ", String.valueOf(ListaResultadosConvertida.size()));
                            ...
                            for (int i = 0; i < ListaResultadosConvertida.size(); i++){
                                ...
                                Log.d("listResultadosSalida4 = ", opcion);
