...
public class GameActivitySelector5 extends AppCompatActivity {
...
// Later.. stop the animation
    ...
    //REGULAR EL CONTADOR,NO SE PASA BIEN DEL 5 AL 6 Y CONTINUACION.
    //INTENTAR CONFIGURAR FRAGMENTS PARA SOLO USAR 1 ACTIVITY
        ...
        btnSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(getType(id)=="radio"){
                    ...
                    Log.d("listResultados5 = ", String.valueOf((listaResultados.size())));

                    overridePendingTransition(R.anim.zoom_back_in, R.anim.zoom_back_out);
                    startActivityForResult(intent, 0);
                }else if(getType(id)=="likert"){
                    Log.d("aviso : ", "Game activity Selector");
                    Intent intent = new Intent(v.getContext(), GameActivitySelector6.class);
                    intent.putExtra("parametro", contador);
                    intent.putExtra("parametro2", progress);
                    intent.putStringArrayListExtra("parametro3", (ArrayList<String>) listaResultados);
                    Log.d("listResultados5 = ", String.valueOf((listaResultados.size())));
        ...
        APIClientGravity.getInstance().getApi().getFormApi(Integer.valueOf(id)).enqueue(
                new Callback<Form>() {
                    ...
                    public void onResponse(Call<Form> call,
                        ...
                        if (!GameActivitySelector5.this.isFinishing() && progressDialog.isShowing())
                        ...
                        if (response.isSuccessful()) {
                            ...
                            for(Form.Choice opcion : list) {
                                ...
                                if(opcion.getText().equals(selectedText)){
                                    ...
                                    Log.d("listResultadosEntrada5 = ", objeto);
                                    Log.d("listaResultadosSizeFor5 = ", String.valueOf(ListaResultadosConvertida.size()));
                                }else{
                                    Log.d("listResultadosEntrada5 = ", "NO HAY OBJETOS QUE COINCIDAN");
                                }
                            }

                            Log.d("listaResultadosSizeOutFor5 = ", String.valueOf(ListaResultadosConvertida.size()));
                            ...
                            for (int i = 0; i < ListaResultadosConvertida.size(); i++){
                                ...
                                Log.d("listResultadosSalida5 = ", opcion);
