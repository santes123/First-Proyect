...
import com.pumpun.proyectformapiantoniogonzalez.Activities.Formulario1.Fragments.fragment_text.GameActivityText2;
...
public class GameActivityRadioButtons2 extends AppCompatActivity {
        ...
        btnSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(getType(id)=="radio"){
                    ...
                    Log.d("listResultados10 = ", String.valueOf((listaResultados.size())));
                    ...
                    Intent intent = new Intent(v.getContext(), GameActivityText2.class);
                    intent.putExtra("parametro", contador);
                    intent.putExtra("parametro2", progress);
                    intent.putStringArrayListExtra("parametro3", (ArrayList<String>) listaResultados);
                    Log.d("listResultados10 = ", String.valueOf((listaResultados.size())));
        ...
        RbAnswer1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(getType(id)=="radio"){
                    ...
                    Log.d("aviso : ", "Game activity Text");
                    Intent intent = new Intent(view.getContext(), GameActivityText2.class);
                    intent.putExtra("parametro", contador);
                    startActivityForResult(intent, 0);
                }else{
                    Log.d("aviso : ", "Game activity");
        ...
        APIClientGravity.getInstance().getApi().getFormApi(Integer.valueOf(id)).enqueue(
                new Callback<Form>() {
                    ...
                    public void onResponse(Call<Form> call,
                        ...
                        if (!GameActivityRadioButtons2.this.isFinishing() && progressDialog.isShowing())
                        ...
                        if (response.isSuccessful()) {
                            ...
                            for(Form.Choice opcion : list) {
                                ...
                                if(opcion.getText().equals(selectedText)){
                                    ...
                                    Log.d("listResultadosEntrada10 = ", "NO HAY OBJETOS QUE COINCIDAN");
                                }
                            }

                            Log.d("listaResultadosSizeOutFor10 = ", String.valueOf(ListaResultadosConvertida.size()));
                            ...
                            for (int i = 0; i < ListaResultadosConvertida.size(); i++){
                                ...
                                Log.d("listResultadosSalida10 = ", opcion);
